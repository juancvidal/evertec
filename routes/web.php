...
Route::post('/order', 'OrdenController@create')->name('order');
Route::get('/orders', 'OrdenController@index')->name('orders');
Route::get('/state/{reference}', 'OrdenController@state')->name('state');
